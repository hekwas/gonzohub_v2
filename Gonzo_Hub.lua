...
COLOR_CARD_GRAD_1   = COLOR_CARD_GRAD_1   or Color3.fromRGB(10, 10, 10)
COLOR_CARD_GRAD_2   = COLOR_CARD_GRAD_2   or Color3.fromRGB(20, 20, 20)
COLOR_CARD_GRAD_3   = COLOR_CARD_GRAD_3   or Color3.fromRGB(30, 30, 30)

COLOR_STROKE_GLOW   = COLOR_STROKE_GLOW   or Color3.fromRGB(255, 255, 255)
COLOR_STROKE_MAIN   = COLOR_STROKE_MAIN   or Color3.fromRGB(255, 255, 255)

COLOR_SURFACE       = COLOR_SURFACE       or Color3.fromRGB(15, 15, 15)
COLOR_SURFACE_DARK  = COLOR_SURFACE_DARK  or Color3.fromRGB(5, 5, 5)

COLOR_TEAL_ON       = COLOR_TEAL_ON       or Color3.fromRGB(255, 255, 255)

COLOR_TEXT          = COLOR_TEXT          or Color3.fromRGB(255, 255, 255)
COLOR_TEXT_MUTED    = COLOR_TEXT_MUTED    or Color3.fromRGB(170, 170, 170)
...
local top = _makeTopBar(card, "Gonzo Hub Discord")
